...
class FIGMMCreatorTests: XCTestCase {
    ...
    func test_when_update_zois_with_visits_without_zois_then_create_zois() {
        ...
        var x_mean = (zoiToTest!["mean"] as! [Any])[0] as! Double
        var y_mean = (zoiToTest!["mean"] as! [Any])[1] as! Double
        ...
        XCTAssert((zoiToTest!["accumulator"] as! Double) == 1.0)
        XCTAssert((zoiToTest!["age"] as! Double) == 1.0)
        x_mean = (zoiToTest!["mean"] as! [Any])[0] as! Double
        y_mean = (zoiToTest!["mean"] as! [Any])[1] as! Double
        XCTAssert(x_mean == 111319.49079327357)
        XCTAssert(y_mean == 222684.20850554318)
    ...
    func test_when_update_zois_prior_then_update_zois_prior_values() {
        var listZoisToTest: [[String: Any]] = []
        var zoiToTest1 = [String: Any]()
        var zoiToTest2 = [String: Any]()
        var zoiToTest3 = [String: Any]()
    ...
    func test_when_update_zois_with_a_visit_near_an_existing_cluster_then_update_and_requalify_zois() {
        ...
        var zoi2_before_update =  [String: Any]()
        for zoi in allZoi {
        ...
        var zoi2_after_update =  [String: Any]()
        for zoi in allZoi {
            for id in zoi["idVisits"] as! [String] {
                if id == visit4.getId() {
        ...
        let x_mean = (zoi2_after_update["mean"] as! [Any])[0] as! Double
        let y_mean = (zoi2_after_update["mean"] as! [Any])[1] as! Double
        XCTAssert(x_mean == 222638.98158654713)
