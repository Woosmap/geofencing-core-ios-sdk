...
func predict_as_dict(visitPoint: LoadedVisit) {
    ...
    for zois_gmm_info in list_zois {
        ...
        let x_mean = (zois_gmm_info["mean"] as! [Any])[0] as! Double
        let y_mean = (zois_gmm_info["mean"] as! [Any])[1] as! Double
...
func updateCluster(point: LoadedVisit, x_j_probability: Double, zoi_gmminfo: inout [String: Any], normalization_coefficient: Double) {
    ...
    let x_mean = (zoi_gmminfo["mean"] as! [Any])[0] as! Double
    let y_mean = (zoi_gmminfo["mean"] as! [Any])[1] as! Double
...
func geometryFigmm(zois_gmm_info:inout [String: Any]) {
    typealias Scalar = Double
