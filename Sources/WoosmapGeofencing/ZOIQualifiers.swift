...
func updateZoisQualifications(zois: [[String: Any]]) -> [[String: Any]] {
    ...
    var firstHomePeriod = [String: Any]()
    firstHomePeriod["start"] = 0
    firstHomePeriod["end"] = 7
    var secondHomePeriod = [String: Any]()
...
func update_recurrent_zois_status() {
    var list_zois_to_update: [[String: Any]] = []
...
func qualify_recurrent_zoi(zois_gmm_info: inout [String: Any]) {
    ...
    let intervals = zois_gmm_info["average_intervals"] as! [[String: Any]]
    for key in PERIODS {
...
func get_periods_length(period_segments: [String: Any]) -> Int {
    ...
    for (_, value) in period_segments {
        for period_segment in value as! [[String: Any]] {
...
func get_average_presence_intervals(weekly_density: [Double], zois_gmm_info: inout [String: Any]) {
    ...
    let last_daily_presence_interval = daily_presence_intervals[daily_presence_intervals_sortedKeys.last!] as! [[String: Any]]
    var previous_interval = last_daily_presence_interval.last!

    for key in daily_presence_intervals_sortedKeys {
        let current_daily_presence_interval = daily_presence_intervals[key] as! [[String: Any]]
    ...
    for key in daily_presence_intervals.keys {
        var current_daily_presence_interval = daily_presence_intervals[key] as! [[String: Any]]
    ...
    for hour in 0..<weekly_density.count {
        ...
        if previous_density_status != current_status {
            ...
            if daily_presence_intervals[day_key] == nil {
                let list_daily_presence: [[String: Any]] = []
            ...
            var list_daily_presence = daily_presence_intervals[day_key] as! [[String: Any]]

            var daily_presence = [String: Any]()
